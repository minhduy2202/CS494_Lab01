...
public class Constants {
    ...
    public static final long WAITING_TIME_OUT_MS = 10000;
    ...
    public static final int CLIENT_TIMEOUT_PACKET_ID = 203;
    ...
    public static final String CUR_QUESTION_NUMBER = "cur_question_number";
